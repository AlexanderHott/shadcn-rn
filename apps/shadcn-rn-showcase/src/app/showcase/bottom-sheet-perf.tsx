import type { ViewabilityConfig, ViewStyle } from "react-native";
import React, { useCallback, useMemo, useRef, useState } from "react";
import { ActivityIndicator, StyleSheet, Text, View } from "react-native";
import BottomSheet, { BottomSheetFlashList } from "@gorhom/bottom-sheet";

import {
  BottomSheetProvider as BottomSheetProviderPerf,
  BottomSheetTrigger as BottomSheetTriggerPerf,
} from "@/components/ui/bottom-sheet-perf";
...
const FlashListExample = () => {
  ...
  return (
    <View style={styles.container}>
      <Button onPress={() => handleSnapPress(2)}>
        <ButtonText>Snap To 90%</ButtonText>
      </Button>
      <Button onPress={() => handleSnapPress(1)}>
        <ButtonText>Snap To 50%</ButtonText>
      </Button>
      <Button onPress={() => handleSnapPress(0)}>
        <ButtonText>Snap To 25%</ButtonText>
      </Button>
      <Button onPress={handleExpandPress}>
        <ButtonText>Expand</ButtonText>
      </Button>
      <Button onPress={handleCollapsePress}>
...
export default function BottomSheetPerfScreen() {
  return (
    <BottomSheetPerf>
      <BottomSheetTriggerPerf>
