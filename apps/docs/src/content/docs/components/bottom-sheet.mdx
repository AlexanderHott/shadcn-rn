...
import src from "@showcase/components/ui/bottom-sheet.tsx?raw";
import srcShowcase from "@showcase/app/showcase/bottom-sheet.tsx?raw";
import layoutSrc from "@showcase/app/_layout.tsx?raw";
